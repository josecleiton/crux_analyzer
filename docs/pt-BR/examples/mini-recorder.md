...
| Estado | Papel | Descrição | Marcadores | Etiquetas |
| --- | --- | --- | --- | --- |
| Idle | inicial | Nothing is being recorded yet. Every session starts and ends here. | — | — |
...
| Recording | `StopPressed` | Uploading | `AudioOperation::Stop`, `HttpOperation::Upload` → `UploadFinished` (condicional) |
| Paused | `StopPressed` | Uploading | `AudioOperation::Stop`, `HttpOperation::Upload` → `UploadFinished` (condicional) |
...
| Capacidade | Operações | Responde com |
| --- | --- | --- |
